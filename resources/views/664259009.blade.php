    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <!-- Header Section -->
                <div class="mb-8 border-b border-[#e3e3e0] dark:border-[#3E3E3A] pb-6">
                    <h1 class="text-2xl lg:text-3xl font-medium mb-1">นับทอง สู่พิพักดิ์</h1>
                    <p class="text-[#706f6c] dark:text-[#A1A09A] text-sm">นักศึกษาสาขาวิชา วิศวกรรมซอฟต์แวร์</p>
                    <p class="text-[#706f6c] dark:text-[#A1A09A] text-sm mt-1">รหัสนักศึกษา: 664259009</p>
                </div>

                <!-- About Section -->
                <div class="mb-6">
                    <h2 class="font-medium mb-2 text-base">เกี่ยวกับตัวเอง</h2>
                    <p class="text-[#706f6c] dark:text-[#A1A09A]">
                        นักศึกษาวิศวกรรมซอฟต์แวร์ที่มีความสนใจในการพัฒนาซอฟต์แวร์และเทคโนโลยีสารสนเทศ 
                        มีทักษะในการแก้ปัญหาและความสามารถในการทำงานเป็นทีม เป้าหมายการศึกษา คือ การเป็น
                        วิศวกรซอฟต์แวร์ที่สามารถออกแบบและพัฒนาระบบที่มีประสิทธิภาพและปลอดภัย
                    </p>
                </div>

                <!-- Education Section -->
                <div class="mb-6">
                    <h2 class="font-medium mb-2 text-base">การศึกษา</h2>
                    <div class="mb-3">
                        <p class="font-medium">สาขาวิชา: วิศวกรรมซอฟต์แวร์</p>
                        <p class="text-[#706f6c] dark:text-[#A1A09A] text-sm">ระดับ: ปริญญาตรี</p>
                        <p class="text-[#706f6c] dark:text-[#A1A09A] text-sm">สถานะ: นักศึกษาปัจจุบัน</p>
                    </div>
                </div>

                <!-- Skills Section -->
                <div class="mb-6">
                    <h2 class="font-medium mb-2 text-base">ทักษะ</h2>
                    <ul class="flex flex-wrap gap-2">
                        <li class="px-3 py-1.5 rounded-sm bg-[#FDFDFC] dark:bg-[#1b1b18] border border-[#e3e3e0] dark:border-[#3E3E3A]">
                            Java
                        </li>
                        <li class="px-3 py-1.5 rounded-sm bg-[#FDFDFC] dark:bg-[#1b1b18] border border-[#e3e3e0] dark:border-[#3E3E3A]">
                            Python
                ...
                <!-- Interests Section -->
                <div class="mb-6">
                    <h2 class="font-medium mb-2 text-base">สนใจและเป้าหมาย</h2>
                    <ul class="flex flex-col gap-1">
                        <li class="flex items-start gap-2">
                            <span class="mt-1">•</span>
                            <span class="text-[#706f6c] dark:text-[#A1A09A]">การพัฒนาแอปพลิเคชัน Mobile และ Web</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <span class="mt-1">•</span>
                            <span class="text-[#706f6c] dark:text-[#A1A09A]">Cloud Computing และ DevOps</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <span class="mt-1">•</span>
                            <span class="text-[#706f6c] dark:text-[#A1A09A]">Machine Learning Applications</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <span class="mt-1">•</span>
                            <span class="text-[#706f6c] dark:text-[#A1A09A]">Security in Software Development</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="pt-4 border-t border-[#e3e3e0] dark:border-[#3E3E3A]">
                    <h2 class="font-medium mb-2 text-base">ติดต่อ</h2>
                    <p class="text-[#706f6c] dark:text-[#A1A09A] text-sm mb-1">
                        <span class="font-medium">Email:</span> นักศึกษา@university.ac.th
                    </p>
                    <p class="text-[#706f6c] dark:text-[#A1A09A] text-sm mb-1">
                        <span class="font-medium">โทรศัพท์:</span> +66-XXX-XXX-XXXX
                    </p>
                    <p class="text-[#706f6c] dark:text-[#A1A09A] text-sm">
                        <span class="font-medium">สถาบัน:</span> สาขาวิศวกรรมซอฟต์แวร์
                    </p>
                </div>
            </div>
            <div
